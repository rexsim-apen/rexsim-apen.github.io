...
map.getView().fit([-13221355.783025, 3949803.787360, -12918030.983472, 4105531.364863], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Census American Communities Survey Data (Estimates 2019-2023)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (221 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This data is taken from the US Census American Communities Survey dataset, which creates estimates of selected characteristics based on survey data and multipliers determined by census accounting.  Made for APEN July 2025';
            }
