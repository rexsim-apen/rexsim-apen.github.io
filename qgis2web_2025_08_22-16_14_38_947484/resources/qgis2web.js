...
map.getView().fit([-13680432.693449, 4415462.221279, -13469756.457281, 4829511.250761], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">APEN Mapping Tool</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (80 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Data: US American Communities Survey Estimates 2019-23<br />Made for APEN August 2025';
            }
